...
public class FootballScoresWidgetProvider extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Utilies.DATA_UPDATE_ACTION.equals(intent.getAction())) {
    ...
    private void setRemoteAdapterv11(Context context, @NonNull final RemoteViews views) {
        views.setRemoteAdapter(0, R.id.widget_list, new Intent(context, DetailWidgetRemoteViewService.class));
    }
